...
namespace Training\SimpleNews\Controller;
 
use Magento\Framework\App\Action\Context;
use Magento\Framework\App\RequestInterface;
use Magento\Framework\View\Result\PageFactory;
use Training\SimpleNews\Helper\Data;
...
abstract class News extends \Magento\Framework\App\Action\Action
{
   ...
   /**
    * @var \Training\SimpleNews\Helper\Data
    */
   protected $_dataHelper;
 
   /**
    * @var \Training\SimpleNews\Model\NewsFactory
    */
